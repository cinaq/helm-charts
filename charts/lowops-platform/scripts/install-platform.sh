...
export GENERAL_CLIENT_NAME="client"
export BASE_DOMAIN="lowops.cinaq.com"
export EMAIL_DOMAIN="cinaq.com"
export PLATFORM_VERSION="v4.0.0-alpha11"
export CONTAINER_IMAGE="docker.io/cinaq/low-ops-ansible-roles:0-ci-v4-0-0-alpha11"
export PLATFORM_PRIVATE_REGISTRY_USER="user"
export PLATFORM_PRIVATE_REGISTRY_TOKEN="token"
export CHART_VERSION="0.1.2"
export KIND_CLUSTER_VERSION="v1.30.8"
