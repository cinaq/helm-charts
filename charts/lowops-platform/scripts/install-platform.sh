...
export PLATFORM_VERSION="${PLATFORM_VERSION:-v4.0.0-alpha19}"
export CONTAINER_IMAGE="${CONTAINER_IMAGE:-docker.io/cinaq/low-ops-ansible-roles:0-ci-v4-0-0-alpha19}"
...
export CHART_VERSION="${CHART_VERSION:-0.1.10}"
